...
tags: [admin, docs-set, gate1]
---

# 관리자 사이트 — 문서 세트 (초기)

**단일 출처 PRD:** [`../admin-site-prd.md`](../admin-site-prd.md)  
**UI 고정:** [`../admin-site-ui-freeze.md`](../admin-site-ui-freeze.md)  
**구현 분할:** [`../admin-site-implementation-plan.md`](../admin-site-implementation-plan.md)
...
| 문서 | 용도 | 주 독자 |
|------|------|---------|
| [api-contract.md](./api-contract.md) | 관리자 관련 API 권한·엔드포인트·오류 코드 요약 | 프론트·백엔드 |
...
| §4 기능 범위 | PRD, [qa-checklist.md](./qa-checklist.md), [UI Freeze](../admin-site-ui-freeze.md) |
...
| 구현 순서 | [admin-site-implementation-plan.md](../admin-site-implementation-plan.md) |
...
**확정: 안 A** — 비교·기록 [`../../design/admin-site-design-comparison.md`](../../design/admin-site-design-comparison.md)

- 와이어: [`../../design/admin-site-wireframes-option-a.md`](../../design/admin-site-wireframes-option-a.md)
- 정적 목업: [`../../design/artifacts/admin-mockup/`](../../design/artifacts/admin-mockup/)
- Stitch(참고): [`../../design/admin-site-stitch-option-b-cli.md`](../../design/admin-site-stitch-option-b-cli.md)
