...
const EnvSchema = z.object({
  ...
  WEB_PUBLIC_BASE_URL: z.string().default("http://localhost:3000"),
  GLOBAL_TENANT_ID: z.string().default("default-tenant"),
  ADMIN_API_TOKEN: z.string().optional(),
  OAUTH_GOOGLE_CLIENT_ID: z.string().optional(),
  OAUTH_GOOGLE_CLIENT_SECRET: z.string().optional(),
  OAUTH_KAKAO_CLIENT_ID: z.string().optional(),
  OAUTH_KAKAO_CLIENT_SECRET: z.string().optional(),
  OAUTH_NAVER_CLIENT_ID: z.string().optional(),
  OAUTH_NAVER_CLIENT_SECRET: z.string().optional(),
