...
const STEPS: AdminTourStep[] = [
  ...
  },
  {
    id: "stocks",
    title: "종목 관리",
    body: "대시보드에 올릴 관심종목을 등록·비활성합니다. 상단에는 활성 개수와 상한이 보이며, 기본 최대 100개입니다. 상한에 가까우면 새로 활성화하거나 등록하는 것이 제한될 수 있습니다. 종목명 검색 후 결과를 누르면 코드·이름·시장·산업대분류가 채워지고, 직접 입력 시에는 종목코드(신규 시 필수)·종목명·시장·검색 별칭(뉴스·검색용, 쉼표)·테마(신규는 쉼표 입력, 기존 테마는 칩 선택)을 입력합니다. 목록 행을 누르면 수정할 수 있고, 테마 연결은 테마 관리 화면에서 바꿉니다.",
    path: "/admin/stocks",
